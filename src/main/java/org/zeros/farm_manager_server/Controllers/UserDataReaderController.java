...
import org.zeros.farm_manager_server.Domain.DTO.AgriculturalOperations.Operations.AgriculturalOperationDTO;
...
public class UserDataReaderController {
    ...
    Set<AgriculturalOperationDTO> getAllPlannedOperations(@RequestParam(required = false, defaultValue = "OperationType.ANY") OperationType operationType) {
