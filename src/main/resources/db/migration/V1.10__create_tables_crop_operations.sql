...
(
    ...
    total_n_percent              decimal(5, 2) not null,
    total_p_percent              decimal(5, 2) not null,
    total_k_percent              decimal(5, 2) not null,
    total_ca_percent             decimal(5, 2) not null,
    total_mg_percent             decimal(5, 2) not null,
    total_s_percent              decimal(5, 2) not null,
    total_na_percent             decimal(5, 2) not null,
    total_cl_percent             decimal(5, 2) not null,
    total_fe_percent             decimal(5, 2) not null,
    total_b_percent              decimal(5, 2) not null,
    total_si_percent              decimal(5, 2) not null,
    created_by             varchar(36)   not null
) engine = InnoDB;
